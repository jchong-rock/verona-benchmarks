...
int main(const int argc, const char** argv) {
  ...
  // savina.run<actor_benchmark::Concdict>(20, 10000, 0);
  // savina.run<actor_benchmark::Concdict>(20, 10000, 10);
  // savina.run<actor_benchmark::Concdict>(20, 10000, 900);

  // savina.run<boc_benchmark::Concdict>(20, 10000, 0);
  // savina.run<boc_benchmark::Concdict>(20, 10000, 10);
  // savina.run<boc_benchmark::Concdict>(20, 10000, 900);
